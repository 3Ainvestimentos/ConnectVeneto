...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[100] flex max-h-screen w-full max-w-[calc(100vw-1rem)] flex-col-reverse p-2 sm:bottom-0 sm:right-0 sm:top-auto sm:max-w-[420px] sm:flex-col sm:p-4",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "group-[.success]:border-success/40 group-[.success]:hover:border-success/30 group-[.success]:hover:bg-success group-[.success]:hover:text-success-foreground group-[.success]:focus:ring-success",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn(
      "max-h-[40vh] overflow-y-auto break-words whitespace-pre-wrap pr-1 text-sm opacity-90",
      "group-[.destructive]:text-destructive-foreground",
      "group-[.success]:text-success-foreground",
      className
    )}
